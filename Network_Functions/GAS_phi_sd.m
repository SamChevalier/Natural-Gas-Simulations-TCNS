function [phi_sd] = GAS_phi_sd(rho_ns,phi_0,phi_L,Gam,Inputs,Mx3,Mx4i,Bus)
% GAS_phi_nsd: Compute slack flux derivative
%
% Input:
...
%
% Output:
% 1) phi_sd    Function to compute slack line pressure derivative
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Numerical matrix: n-1 densities, Bus.Ln_slk^th eq, and m-Bus.sc to not flip
Mx4iV = Mx4i(n-1 + (m-Bus.sc) + Bus.Ln_slk,:);
