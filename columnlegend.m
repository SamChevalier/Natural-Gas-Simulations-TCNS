function [legend_h,object_h,plot_h,text_strings] = columnlegend(numcolumns, str, plots, varargin)
%
...
if legend_h == false,
    ...
    if ~isempty(extravars),
        ...
        [legend_h,object_h,plot_h,text_strings] = legend(plots, str,'Interpreter','latex','FontSize',13);
    end
end
